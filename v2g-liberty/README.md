...
- Google calendar. This works fine with the Google Calendar integration in Home Assistant (not to be confused with Google Assistant) One could also try the CalDav access to the google calendar: https://developers.google.com/calendar/caldav/v2/guide
